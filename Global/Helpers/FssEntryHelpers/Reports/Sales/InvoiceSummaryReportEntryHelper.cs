...
{
    public static class InvoiceSummaryReportEntryHelper
    {
        public static async Task<string> ExecuteInvoiceSummaryReportEntryAsync(IPage page, string siteCode)
        {
            ...
            await CommonEntryActions.EnterCustomFileNameAsync(frame, $"INVOICE_SUMMARY_REPORT_{siteCode}");

            return await CommonEntryActions.ClickOkAsync(page, frame, CommonEntryHelpers.ReportType.InvoiceSummary, siteCode);
        }
    }
}
