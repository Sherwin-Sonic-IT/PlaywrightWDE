...
//         //     await Assertions.Expect(el).ToBeEnabledAsync(new()
//         //     {
//         //         Timeout = timeout
//         //     });
//         // }
...
//             // await WaitUntilReadyAsync(el, timeout);
...
//             await firstRow.WaitForAsync(new()
//             {
//                 State = WaitForSelectorState.Visible,
//                 Timeout = DefaultTimeout
//             });

//             await Assertions.Expect(firstRow).ToBeEnabledAsync(new()
//             {
//                 Timeout = DefaultTimeout
//             });
